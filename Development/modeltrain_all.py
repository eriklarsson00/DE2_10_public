# -*- coding: utf-8 -*-
"""modelTrain-all.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1zaB_SWV69mFF5IwzQ7Qsfh0ADcjnRngb
"""
...
# Extract 5 random data points and save them before conversion
five_data_points = data.sample(n=5, random_state=42)
# five_data_points.to_csv('5datapoints.csv', index=False)

# Remove these 5 data points from the original dataset
data = data.drop(five_data_points.index).reset_index(drop=True)

# Ensure all remaining features are numeric except for 'full_name'
for col in data.columns:
    if data[col].dtype == 'object' and col != 'full_name':
        data[col] = data[col].astype('category').cat.codes

# Define the target column
target = 'stars'

# Exclude 'full_name' from features
features = data.columns.drop([target, 'full_name'])
...
print("R-squared values have been written to test_accuracy.txt")
